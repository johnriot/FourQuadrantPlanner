...
public final class DataContract {
    ...
    private static final Uri BASE_URI = Uri.parse("content://com.example.fourquadrantcontentprovider/");

    // The URI for this table.
    public static final Uri CONTENT_URI = Uri.withAppendedPath(BASE_URI, TODO_TABLE);
